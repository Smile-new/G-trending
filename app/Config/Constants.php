...
defined('IMG_USER_PATH') || define('IMG_USER_PATH', 'img_user');
...
define('RECURSOS_PUBLICOS_IMAGES', 'recursos_publicos/images');
...
//diseño de login 
define('RECURSOS_LOGIN', 'recursos_login/');
define('RECURSOS_LOGIN_IMAGES', 'recursos_login/img'); 
