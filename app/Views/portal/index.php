                ...
                <div class="row no-gutters slider-text js-fullheight align-items-center">
                    <div class="col-md-10 col-lg-7 ftco-animate">
                        <div class="text w-100">
                            <h2>Desbloquea el Futuro de tu Comunidad</h2>
                            <h1 class="mb-3">Convertimos Datos en Inteligencia Estratégica</h1>
        ...
        <div class="slider-item js-fullheight" style="background-image:url(<?= base_url(RECURSOS_PUBLICOS_IMAGES . '/10.jpg') ?>);">
            ...
            <div class="container">
                <div class="row no-gutters slider-text js-fullheight align-items-center">
                    <div class="col-md-10 col-lg-7 ftco-animate">
                        <div class="text w-100">
                            <h2>El Pulso Real de tu Entorno</h2>
                            <h1 class="mb-3">Censos y Encuestas que Definen Tendencias</h1>
                            <div class="d-flex meta">
                                <div class=""><p class="mb-0"><a href="#" class="btn btn-secondary py-3 px-2 px-md-4">Ver Estudios de Caso</a></p></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="slider-item js-fullheight" style="background-image:url(<?= base_url(RECURSOS_PUBLICOS_IMAGES . '/11.png') ?>);">
            ...
            <div class="container">
                <div class="row no-gutters slider-text js-fullheight align-items-center">
                    <div class="col-md-10 col-lg-7 ftco-animate">
                        <div class="text w-100">
                            <h2>Decisiones con Propósito</h2>
                            <h1 class="mb-3">Información Actualizada para el Impacto Real</h1>
                            <div class="d-flex meta">
                                <div class=""><p class="mb-0"><a href="#" class="btn btn-secondary py-3 px-2 px-md-4">Agenda tu Consulta</a></p></div>
                            </div>
                        </div>
                    </div>
                </div>
