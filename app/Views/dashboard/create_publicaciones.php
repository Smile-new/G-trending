...
<html lang="en" data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" dir="ltr" data-pc-theme="light">
  <head>
    <title><?= $page_title ?? 'Crear Publicación'; ?> | Datta Able Dashboard Template</title>
    <meta charset="utf-8" />
  ...
  <div class="navbar-wrapper">
    ...
    <div class="navbar-content h-[calc(100vh_-_74px)] py-2.5">
       <ul class="pc-navbar">
                           ...
                           <li class="pc-item pc-hasmenu">
                                 <a href="<?= base_url('publicaciones'); ?>" class="pc-link"> <span class="pc-micon"> <i data-feather="book"></i></span>
                ...
                <div class="grid grid-cols-12 items-center">
                    ...
                    <div class="col-span-4 text-right">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?= base_url('publicaciones'); ?>">Publicaciones</a></li>
            ...
            <div class="col-span-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">Formulario de Nueva Publicación</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <?= form_open_multipart('publicaciones/store'); ?>
                            <?= csrf_field(); ?>

                            <div class="mb-3">
                                <label for="titulo" class="form-label">Título <span class="text-danger">*</span></label>
                                <input type="text" class="form-control <?= session('validation.titulo') ? 'is-invalid' : '' ?>" id="titulo" name="titulo" value="<?= old('titulo') ?>" required>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control <?= session('validation.descripcion') ? 'is-invalid' : '' ?>" id="editor" name="descripcion" rows="10"><?= old('descripcion') ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control <?= session('validation.fecha_publicacion') ? 'is-invalid' : '' ?>" id="fecha_publicacion" name="fecha_publicacion" value="<?= old('fecha_publicacion', date('Y-m-d')) ?>" required>
                                <?php if (session('validation.fecha_publicacion')): ?>
                                    <div class="invalid-feedback">
                                        <?= session('validation.fecha_publicacion') ?>
                                    </div>
                                <?php endif; ?>
                            </div>

                            <div class="mb-3">
                                <label for="ruta_foto" class="form-label">Imagen (JPG, JPEG, PNG)</label>
                                <input class="form-control <?= session('validation.ruta_foto') ? 'is-invalid' : '' ?>" type="file" id="ruta_foto" name="ruta_foto" accept="image/jpeg,image/png">
                                <?php if (session('validation.ruta_foto')): ?>
                                    <div class="invalid-feedback">
                                        <?= session('validation.ruta_foto') ?>
                                    </div>
                                <?php endif; ?>
                            </div>

                            <div class="mb-3">
                                <label for="ruta_pdf" class="form-label">Archivo PDF</label>
                                <input class="form-control <?= session('validation.ruta_pdf') ? 'is-invalid' : '' ?>" type="file" id="ruta_pdf" name="ruta_pdf" accept="application/pdf">
                                <?php if (session('validation.ruta_pdf')): ?>
                                    <div class="invalid-feedback">
                                        <?= session('validation.ruta_pdf') ?>
                                    </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control <?= session('validation.categoria_id') ? 'is-invalid' : '' ?>" id="categoria_id" name="categoria_id" required>
                                ...
                                <?php if (session('validation.categoria_id')): ?>
                                    <div class="invalid-feedback">
                                        <?= session('validation.categoria_id') ?>
                                    </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <a href="<?= base_url('publicaciones'); ?>" class="btn btn-secondary">Cancelar</a>
                        <?= form_close(); ?>
                    </div>
                </div>
            </div>
