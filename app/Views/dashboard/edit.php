...
<nav class="pc-sidebar">
  <div class="navbar-wrapper">
    ...
    <li class="pc-item pc-hasmenu">
        <a href="<?= base_url('edit'); ?>" class="pc-link"> <span class="pc-micon"> <i data-feather="edit"></i></span>
            <span class="pc-mtext">Color</span>
        </a>
    </li>
    <li class="pc-item pc-hasmenu">
        <a href="<?= base_url('render'); ?>" class="pc-link"> <span class="pc-micon"> <i data-feather="type"></i></span>
    ...
    <li class="pc-item pc-hasmenu">
        <a href="<?= base_url('user'); ?>" class="pc-link"> <span class="pc-micon"> <i data-feather="user-plus"></i></span>
            <span class="pc-mtext">Users / Register</span> </a>
    </li>
    </ul>
    </div>
  </div>
