...
<html lang="en" data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" dir="ltr" data-pc-theme="light">
  <head>
    <title><?= $page_title ?? 'Gestión de Publicaciones'; ?> | Datta Able Dashboard Template</title>
    <meta charset="utf-8" />
                ...
                <div class="grid grid-cols-12 items-center">
                    <div class="col-span-8">
                        <div class="page-header-title">
                            <h4 class="mb-0">Gestión de Publicaciones</h4>
                        </div>
                    </div>
                    <div class="col-span-4 text-right">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?= base_url('dashboard'); ?>">Home</a></li>
                            <li class="breadcrumb-item"><a href="<?= base_url('publicacion'); ?>">Publicaciones</a></li>
            ...
            <div class="col-span-12">
                <div class="card">
                    <div class="card-header flex justify-between items-center">
                        <h5 class="mb-0">Listado de Publicaciones</h5>
                        <a href="<?= base_url('publicacion/create'); ?>" class="btn btn-primary">
                            <i data-feather="plus"></i> Nueva Publicación
                        </a>
                    </div>
                    <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if (!empty($publicacion['ruta_foto'])): ?>
                                                        <a href="<?= base_url($publicacion['ruta_foto']); ?>" target="_blank">
                                                            <img src="<?= base_url($publicacion['ruta_foto']); ?>" alt="Foto Publicación" class="img-thumbnail" style="width: 80px; height: auto;">
                                                        </a>
                                                    <?php else: ?>
                                                        N/A
                                                    <?php endif; ?>
                                                ...
                                                <td>
                                                    <?php if (!empty($publicacion['ruta_pdf'])): ?>
                                                        <a href="<?= base_url($publicacion['ruta_pdf']); ?>" target="_blank" class="text-primary">Ver PDF</a>
                                                    <?php else: ?>
                                                        N/A
                                                    <?php endif; ?>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="flex gap-2">
                                                        <a href="<?= base_url('publicacion/edit/' . $publicacion['id']); ?>" class="btn btn-sm btn-info" title="Editar">
                                                            <i data-feather="edit"></i>
                                                        </a>
                                                        
                                                        <form action="<?= base_url('publicacion/delete/' . $publicacion['id']); ?>" method="post" class="inline" onsubmit="return confirm('¿Estás seguro de que quieres eliminar esta publicación?');">
                                                            <?= csrf_field(); ?>
